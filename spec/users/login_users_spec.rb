...
before do
    ...
    scenario "see create pub button user 1" do 
    ...
    scenario "see create pub button user 2" do 
    ...
    scenario "create pub and see it user 1" do 
        fill_in "Email", :with => @user1.email
    	fill_in "Password", :with => @user1.password
    	click_button "Log in"
    	expect(page).to have_link('Create your own pub')
   ...
   scenario "create pub and see it user 2" do 
        fill_in "Email", :with => @user2.email
    	fill_in "Password", :with => @user2.password
    	click_button "Log in"
    	expect(page).to have_link('Create your own pub')
    ...
    scenario "favorite pubs" do
   	...
   	expect(page).to have_content('Administrator')
        ...
        click_link("Favorite")
        visit root_path
        expect(page).to have_content("Your favorite pubs (1)" )
        expect(page).to have_link("irish pub2")
        click_link("account")
        find("a#logout").click
        visit login_path
    ...
    scenario "visited pubs" do
   	...
   	expect(page).to have_content('Administrator')
        ...
        expect(page).to have_link("irish pub2")
        click_link("irish pub2")
        expect(page).to have_link("I have been here!")
        click_link("I have been here!")
        visit root_path
        expect(page).to have_content("Your visited pubs (1)" )
        expect(page).to have_link("irish pub2")
        click_link("account")
        find("a#logout").click
        visit login_path
    ...
    scenario "edit answer" do
   	...
   	expect(page).to have_content('Administrator')
        ...
        expect(page).to have_link("irish pub2")
        click_link("irish pub2")
        expect(page).to have_link("Answers(1)")
        click_link("Answers(1)")
        expect(page).to have_content("this is a new review")
        expect(page).to have_content("this is a new answer")
        click_link("edit")
        fill_in "Compose new answer...", :with => "this is a new answer 1" 
        click_button "Post"
        ...
        expect(page).to have_content("this is a new answer")
        click_link("edit")
        fill_in "Compose new answer...", :with => "this is a new answer 2" 
        click_button "Post"
        expect(page).to have_content("Answer updated")
    end
end
